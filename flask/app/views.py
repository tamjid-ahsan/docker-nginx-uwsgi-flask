...
@app.route("/")
def index():
    return "Hello from FLASK. testing by TA"
...
# Imports & Functions
###############################################################################
preprocessor = joblib.load('./app/data/preprocessor.joblib')
nume_col = joblib.load('./app/data/nume_col.joblib')
cate_col = joblib.load('./app/data/cate_col.joblib')
prediction_model = joblib.load(
    './app/data/xgb_clf_churn_prediction_all_data.joblib')
kmeans_model = joblib.load('./app/data/kmeans_segmentation_model.joblib')
